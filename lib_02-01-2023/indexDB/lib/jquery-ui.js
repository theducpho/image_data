...
/*
 * ! jQuery UI Core 1.11.0 http://jqueryui.com
 * 
		...
		if ( this.length ) {
			...
			while ( elem.length && elem[ 0 ] !== document ) {
				...
				if ( position === "absolute" || position === "relative" || position === "fixed" ) {
					...
					// we ignore the case of nested elements with an explicit
					// value of 0
...
/*
 * ! jQuery UI Widget 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Mouse 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Position 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Accordion 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Menu 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
var menu = $.widget( "ui.menu", {
		...
		this._on({
			...
			"click .ui-menu-item": function( event ) {
				...
				if ( !this.mouseHandled && target.not( ".ui-state-disabled" ).length ) {
					...
					// Only set the mouseHandled flag if the event will bubble,
					// see #9469.
					...
					if ( target.has( ".ui-menu" ).length ) {
						...
						// If the active item is on the top level, let it stay
						// active.
						// Otherwise, blur the active item since it is no longer
						// visible.
	...
	collapseAll: function( event, all ) {
		clearTimeout( this.timer );
		this.timer = this._delay(function() {
			// If we were passed an event, look for the submenu that contains
			// the event
			var currentMenu = all ? this.element :
				$( event && event.target ).closest( this.element.find( ".ui-menu" ) );

			// If we found no valid submenu ancestor, use the main menu to close
			// all sub menus anyway
...
/*
 * ! jQuery UI Autocomplete 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
			...
			keydown: function( event ) {
				...
				case keyCode.ESCAPE:
					if ( this.menu.element.is( ":visible" ) ) {
						...
						this.close( event );
						// Different browsers have different default behavior
						// for escape
				...
				default:
					suppressKeyPressRepeat = true;
					// search timeout should be triggered before the input value
					// is changed
		...
		this._on( this.menu.element, {
			...
			menufocus: function( event, ui ) {
				...
				if ( false !== this._trigger( "focus", event, { item: item } ) ) {
					// use value to match what will end up in the input, if it
					// was a key event
...
/*
 * ! jQuery UI Button 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
	...
	_create: function() {
		...
		if ( this.type === "checkbox" ) {
			...
			this.buttonElement
				...
				// see #8559, we bind to blur here in case the button element
				// loses
			...
			if ( this.buttonElement.is("a") ) {
				this.buttonElement.keyup(function(event) {
					if ( event.keyCode === $.ui.keyCode.SPACE ) {
						// TODO pass through original event correctly (just as
...
/*
 * ! jQuery UI Datepicker 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Draggable 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
		...
		$(o.connectToSortable).each(function() {
			...
			if (sortable && !sortable.options.disabled) {
				...
				sortable.refreshPositions();	// Call the sortable's
												...
												// sortable container cache is
												// used in drag and needs to be
												// up to date (this will ensure
												// it's initialised as well as
												// being kept in step with any
...
/*
 * ! jQuery UI Resizable 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Dialog 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Droppable 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
function stringParse( string ) {
	...
	if ( rgba.length ) {
		...
		// if this came from a parsed string, force "transparent" when alpha is
		// 0
			...
			if ( red instanceof color ) {
				...
				each( spaces, function( spaceName, space ) {
					...
					each( space.props, function( key, prop ) {
						...
						// if the cache doesn't exist, and we know how to
						// convert
						if ( !inst[ cache ] && space.to ) {

							// if the value was null, we don't need to copy it
							// if the key was alpha, we don't need to copy it
							// either
						...
						// this is the only case where we allow nulls for ALL
						// properties.
...
spaces.hsla.to = function( rgba ) {
	...
	// otherwise, saturation is based on the ratio of chroma (diff) to lightness
	// (add)
	if ( diff === 0 ) {
		s = 0;
	} else if ( l <= 0.5 ) {
		...
		jQuery.cssHooks[ hook ] = {
			set: function( elem, value ) {
				...
				try {
					...
					// wrapped to prevent IE from throwing errors on "invalid"
...
$.extend( $.effects, {
	...
	restore: function( element, set ) {
		...
		for ( i = 0; i < set.length; i++ ) {
			if ( set[ i ] !== null ) {
				...
				// jQuery 1.6.2 incorrectly returns undefined for any falsy
				// value.
				// We can't differentiate between "" and 0 here, so we just
				// assume
	...
	// this should be a little more flexible in the future to handle a string &
	// hash
	...
	createWrapper: function( element ) {
		...
		wrapper = element.parent(); // Hotfix for jQuery 1.4 since some change
									// in wrap() seems to actually lose the
...
/*
 * ! jQuery UI Effects Blind 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Bounce 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
var effectBounce = $.effects.effect.bounce = function( o, done ) {
	...
	downAnim = {};
	downAnim[ ref ] = 0;
	// Bounces up/down/left/right then back to 0 -- times * 2 animations happen
	// here
	for ( i = 0; i < times; i++ ) {
		upAnim = {};
...
/*
 * ! jQuery UI Effects Clip 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Drop 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Explode 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
var effectExplode = $.effects.effect.explode = function( o, done ) {
	...
	for ( i = 0; i < rows ; i++ ) { // ===>
		...
		for ( j = 0; j < cells ; j++ ) { // |||
			...
			// positioned based on
			// where the original was located +left and +top equal to the size
			// of pieces
				.parent()
...
/*
 * ! jQuery UI Effects Fade 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Fold 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Highlight 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Size 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
				...
				if ( position === "static" ) {
					...
					$.each([ "top", "left" ], function( idx, pos ) {
						el.css( pos, function( _, str ) {
							...
							// if original was "auto", recalculate the new value
							// from wrapper
							if ( str === "auto" ) {
								return toRef + "px";
							}
...
/*
 * ! jQuery UI Effects Scale 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Puff 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Pulsate 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Shake 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Slide 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Effects Transfer 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Progressbar 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Selectable 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Selectmenu 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Slider 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Sortable 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
var sortable = $.widget("ui.sortable", $.ui.mouse, {
	...
	_mouseStart: function(event, overrideHandle, noActivation) {
		...
		this._mouseDrag(event); // Execute the drag once - this causes the
								// helper not to be visible before getting its
								// correct position
		return true;
	...
	_refreshItems: function(event) {
		...
		if(connectWith && this.ready) { // Shouldn't be run the first time
										// through due to massive slow-down
			for (i = connectWith.length - 1; i >= 0; i--){
				cur = $(connectWith[i]);
				for (j = cur.length - 1; j >= 0; j--){
					inst = $.data(cur[j], this.widgetFullName);
	...
	_rearrange: function(event, i, a, hardRefresh) {
		...
		this._delay(function() {
			if(counter === this.counter) {
				this.refreshPositions(!hardRefresh); // Precompute after each
														// DOM insertion, NOT on
														// mousemove
			}
		});
...
/*
 * ! jQuery UI Spinner 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
		...
		"mousedown .ui-spinner-button": function( event ) {
			...
			function checkFocus() {
				...
				if ( !isActive ) {
					...
					// focus
					// moved off of the input because the user clicked on the
					// button.
					this._delay(function() {
						this.previous = previous;
					});
...
/*
 * ! jQuery UI Tabs 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Tooltip 1.11.0 http://jqueryui.com
 * 
 * Copyright 2014 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
