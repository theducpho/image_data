...
import 'package:slide_puzzle_number/src/audio/background_audio_controller.dart';
import 'package:slide_puzzle_number/src/audio/button_audio_controller.dart';
...
SingleModePlayboardController simpleModeControllerProvider(Ref ref) {
...
SingleModePlayboardController mediumModeControllerProvider(Ref ref) {
  final color = ref.watch(playboardInfoControllerProvider.select((value) => value.color));
...
SingleModePlayboardController hardModeControllerProvider(Ref ref) {
  final color = ref.watch(playboardInfoControllerProvider.select((value) => value.color));
