...
import 'package:slide_puzzle_number/src/controllers/playboard_controller.dart';
import 'package:slide_puzzle_number/src/controllers/playboard_info_controller.dart';
import 'package:slide_puzzle_number/src2/home_page.dart';
import 'package:slide_puzzle_number/src/single_mode/controllers/single_mode_controller.dart';
import 'package:slide_puzzle_number/src/single_mode/screens/single_mode_page.dart';
import 'package:slide_puzzle_number/src/utils/app_infos/app_infos.dart';
import 'package:slide_puzzle_number/src/widgets/slideparty_button_params.dart';
  ...
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/s_mode',
        builder: (context, state) {
          AppInfos.setAppTitle('Slide Puzzle - Simple Mode');
